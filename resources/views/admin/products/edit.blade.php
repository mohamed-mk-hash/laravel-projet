                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title" id="title" class="form-control" placeholder="Title" value="{{ $product->titel }}">
                                            <p class="error"></p>	
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <select multiple class="related-product w-100" name="related_products[]" id="related_products">
                                        @if(!empty($relatedProducts))
                                            @foreach ($relatedProducts as $relatedProduct)
                                                <option value="{{ $relatedProduct->id }}" selected>{{ $relatedProduct->titel }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    <p class="error"></p>
...
@section('customJs')
    ...
    $.ajax({
        ...
        function deleteImage(id){
            $("#image-row-"+id).remove();
            if(confirm("Are You sur you want to delete image?")){
                $.ajax({
