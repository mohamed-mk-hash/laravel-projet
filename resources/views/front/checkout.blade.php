...
<main>
    ...
    <section class="section-9 pt-4">
        <div class="container">
            <form action="post" name="orderForm" id="orderForm">
                <div class="row">
                    <div class="col-md-8">
                        <div class="sub-title">
                        ...
                        <div class="card shadow-lg border-0">
                            <div class="card-body checkout-form">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <input type="text" name="city" id="city" class="form-control" placeholder="Baladia" value="{{ (!empty($customerAddress)) ? $customerAddress->city : '' }}">
                                            <p></p>
                                        </div>            
                                    </div>
