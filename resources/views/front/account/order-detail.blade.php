                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-4 col-md-3 col-xl-2">
                                                ...
                                                @if (!empty($productImage->image))
                                                    <img class="img-fluid" src="{{ asset('uploads/product/small/'.$productImage->image) }}" class="img-thumbnail" > 
                                                @else
                                                    <img class="img-fluid" src="{{ asset('admin-assets/img/default-150x150.png') }}" class="img-thumbnail" >                                            
                                                @endif
